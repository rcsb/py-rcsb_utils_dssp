...
packages = []
thisPackage = "rcsb.utils.dssp"

with open("rcsb/utils/dssp/__init__.py", "r", encoding="utf-8") as fd:
...
setup(
    ...
    url="https://github.com/rcsb/py-rcsb_utils_dssp",
    #
    license="Apache 2.0",
    classifiers=(
    ...
    packages=find_packages(exclude=["rcsb.mock-data", "rcsb.utils.tests-dssp", "rcsb.utils.tests-*", "tests.*"]),
    package_data={
        # If any package contains *.md or *.rst ...  files, include them:
        "": ["*.md", "*.rst", "*.txt", "*.cfg"]
    },
    #
    test_suite="rcsb.utils.tests-dssp",
    tests_require=["tox"],
    #
    # Not configured ...
